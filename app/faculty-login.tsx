    ...
    <AppScreen scrollable>
      ...
      <View style={styles.container}>
        <View style={styles.branding}>
          <IconSymbol size={48} name="briefcase.fill" color={APP_COLORS.primary} />
        </View>

        <Text style={styles.title}>Faculty Portal</Text>
        <Text style={styles.subtitle}>Enter your faculty credentials to take attendance and manage classes.</Text>
